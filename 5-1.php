...
名前：<input type = "text" name ="name" placeholder="<?php if($editname==""){echo "名前";}?>"value="<?php if($editname!=""){echo $editname;}?>"><br>    
コメント：<input type = "text" name ="comment" placeholder="<?php if($editcomment==""){echo "最近はまっていること";}?>"value="<?php if($editname!=""){echo $editcomment;}?>"><br>
